...
import 'package:e_document_app/controllers/proposal_document_controller.dart';
...
class AssignDocController extends GetxController {
  AssignDocController();
    ...
    res.fold((left) {
      ...
      if (assignDocModel.value.errorCode.toString() == "0") {
        ...
        Future.delayed(const Duration(seconds: 1), () {
          ...
          Get.find<ProposalDocumentController>().submitProposalData();
